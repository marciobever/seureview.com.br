        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-[58ch]">
              ...
              <strong>Mercado Livre</strong>, <strong>AliExpress</strong> e <strong>Temu</strong> — com legendas
              inteligentes, links rastreáveis (UTM/SubIDs) e um fluxo simples para publicar nas redes.
            </p>
